...
subprocesses à ~30 % des cœurs disponibles, et abaissement de la priorité OS
des threads/process qui font le travail pour laisser le premier plan
répondre."""
import os

THROTTLE_FRACTION = 0.3  # ~30 % des cœurs disponibles


def throttled_worker_count(minimum: int = 1) -> int:
    """Nombre de workers/subprocesses correspondant à ~30 % des cœurs
